...
+ [did_multiplegt_dyn with periodically missing outcomes: a tutorial for DiD with electoral data (Stata, R)](https://github.com/DiegoCiccia/did_multiplegt_dyn/blob/main/vignettes/vignette_1.md)
