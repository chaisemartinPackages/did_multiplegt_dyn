...
did_multiplegt_dyn_core <- function(
  ...
  for (i in 1:l_u_a_XX) {
    ...
    df[, paste0("diff_y_", i, "_XX") := outcome_XX - lag(outcome_XX, i), by = group_XX]
    ...
    df[, paste0("count_cohort_",i,"_ns_t_XX") := sum(N_gt_XX[!is.na(get(paste0("diff_y_",i,"_XX"))) & get(paste0("never_change_d_",i,"_XX")) == 1 & get(paste0("N",increase_XX,"_t_",i,"_XX")) > 0 & !is.na(get(paste0("N",increase_XX,"_t_",i,"_XX")))], na.rm = TRUE), by = c("d_sq_XX", "time_XX", trends_nonparam)]
    ...
    df[, paste0("total_cohort_",i,"_ns_t_XX") := sum(get(paste0("diff_y_",i,"_N_gt_XX"))[get(paste0("never_change_d_",i,"_XX")) == 1 & get(paste0("N",increase_XX,"_t_",i,"_XX")) > 0 & !is.na(get(paste0("N",increase_XX,"_t_",i,"_XX")))], na.rm = TRUE), by = c("d_sq_XX", "time_XX", trends_nonparam)]
    ...
    df[, paste0("dof_cohort_",i,"_ns_t_XX") := sum(get(paste0("dof_y_",i,"_N_gt_XX"))[!is.na(get(paste0("diff_y_",i,"_XX"))) & get(paste0("never_change_d_",i,"_XX")) == 1 & get(paste0("N",increase_XX,"_t_",i,"_XX")) > 0 & !is.na(get(paste0("N",increase_XX,"_t_",i,"_XX")))], na.rm = TRUE), by = c("d_sq_XX", "time_XX", trends_nonparam)]
    ...
    # Denominator of the mean
    df[, paste0("count_cohort_",i,"_s_t_XX") := sum(N_gt_XX,na.rm = TRUE), by = c("d_sq_XX", "F_g_XX", "d_fg_XX", paste0("distance_to_switch_",i,"_XX"), trends_nonparam)]
    ...
    # Numerator of the mean
    df[, paste0("total_cohort_",i,"_s_t_XX") := sum(get(paste0("diff_y_",i,"_N_gt_XX")),na.rm = TRUE), by = c("d_sq_XX", "F_g_XX", "d_fg_XX", paste0("distance_to_switch_",i,"_XX"), trends_nonparam)]
    ...
    # Counting number of groups for DOF adjustment
    df[, paste0("dof_cohort_",i,"_s_t_XX") := sum(get(paste0("dof_y_",i,"_N_gt_XX")), na.rm = TRUE), by =  c("d_sq_XX", "F_g_XX", "d_fg_XX", paste0("distance_to_switch_",i,"_XX"), trends_nonparam)]
  ...
  if (placebo != 0) {
    if (l_placebo_u_a_XX >= 1) {
      for (i in 1:l_placebo_u_a_XX) {
        ...
        df[, paste0("diff_y_pl_", i, "_XX") := lag(outcome_XX, 2*i) - lag(outcome_XX, i), by = group_XX]
        ...
        # Denominator of the mean
        df[, paste0("count_cohort_pl_",i,"_ns_t_XX") := sum(N_gt_XX[!is.na(get(paste0("diff_y_pl_",i,"_XX"))) & get(paste0("never_change_d_pl_",i,"_XX")) == 1 & get(paste0("N",increase_XX,"_t_placebo_",i,"_XX")) > 0 & !is.na(get(paste0("N",increase_XX,"_t_placebo_",i,"_XX")))], na.rm = TRUE), by = c("d_sq_XX", "time_XX", trends_nonparam)]
        ...
        # Numerator of the mean
        df[, paste0("total_cohort_pl_",i,"_ns_t_XX") := sum(get(paste0("diff_y_pl_",i,"_N_gt_XX"))[get(paste0("never_change_d_pl_",i,"_XX")) == 1 & get(paste0("N",increase_XX,"_t_placebo_",i,"_XX")) > 0 & !is.na(get(paste0("N",increase_XX,"_t_placebo_",i,"_XX")))], na.rm = TRUE), by = c("d_sq_XX", "time_XX", trends_nonparam)]
        ...
        # Counting number of groups for DOF adjustment
        df[, paste0("dof_cohort_pl_",i,"_ns_t_XX") := sum(get(paste0("dof_y_pl_",i,"_N_gt_XX"))[!is.na(get(paste0("diff_y_pl_",i,"_XX"))) & get(paste0("never_change_d_pl_",i,"_XX")) == 1 & get(paste0("N",increase_XX,"_t_placebo_",i,"_XX")) > 0 & !is.na(get(paste0("N",increase_XX,"_t_placebo_",i,"_XX")))], na.rm = TRUE), by = c("d_sq_XX", "time_XX", trends_nonparam)]
        ...
        # Denominator
        df[, paste0("count_cohort_pl_",i,"_s_t_XX") := sum(N_gt_XX, na.rm = TRUE), by = c("d_sq_XX", "F_g_XX", "d_fg_XX", paste0("dist_to_switch_pl_",i,"_XX"), trends_nonparam)]
        df[[paste0("count_cohort_pl_",i,"_s_t_XX")]] <- ifelse(
              df[[paste0("dist_to_switch_pl_",i,"_XX")]] == 1,
              df[[paste0("count_cohort_pl_",i,"_s_t_XX")]], NA)

        # Numerator
        df[, paste0("total_cohort_pl_",i,"_s_t_XX") := sum(get(paste0("diff_y_pl_",i,"_N_gt_XX")), na.rm = TRUE), by = c("d_sq_XX", "F_g_XX", "d_fg_XX", paste0("dist_to_switch_pl_",i,"_XX"), trends_nonparam)]
        ...
        # Counting number of groups for DOF adjustment
        df[, paste0("dof_cohort_pl_",i,"_s_t_XX") := sum(get(paste0("dof_y_pl_",i,"_N_gt_XX")), na.rm = TRUE), by =  c("d_sq_XX", "F_g_XX", "d_fg_XX", paste0("dist_to_switch_pl_",i,"_XX"), trends_nonparam)]
  ...
  if (isFALSE(trends_lin)) {
    ...
    df$U_Gg_XX<- df$U_Gg_num_XX<- df$U_Gg_den_XX <- df$U_Gg_num_var_XX <- df$U_Gg_var_XX <- NULL
    ...
    for (i in 1:l_u_a_XX) {
      if (get(paste0("N",increase_XX,"_",i,"_XX")) != 0) {
        ...
        df[[paste0("delta_D_",i,"_temp_XX")]] <- NULL
        df[[paste0("delta_D_",i,"_XX")]] <- NULL
