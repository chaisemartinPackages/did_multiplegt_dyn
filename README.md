...
+ [did_multiplegt_dyn with periodically missing outcome: a tutorial for electoral data (Stata, R)](https://github.com/DiegoCiccia/did_multiplegt_dyn/blob/main/vignettes/vignette_1.md)
